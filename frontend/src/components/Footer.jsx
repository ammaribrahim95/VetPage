      ...
      <div style={styles.container}>
        <div style={styles.grid}>
          ...
          <div style={styles.column}>
            ...
            <p style={styles.tagline}>Gentle Care. Professional Treatment. Pets First.</p>
            <div style={styles.iconRow}>
              <Heart size={20} color="rgb(13, 121, 22)" fill="rgb(13, 121, 22)" />
              <span style={styles.iconText}>Caring for your pets since 2014</span>
            </div>
          </div>
          ...
          <div style={styles.column}>
            ...
            <ul style={styles.linkList}>
              ...
              <li><a href="#vets" style={styles.link}>Our Veterinarians</a></li>
          ...
          <div style={styles.column}>
            ...
            <div style={styles.contactInfo}>
              ...
              <div style={styles.contactItem}>
                ...
                <a href="tel:+60106691139" style={styles.contactLink}>+6010-669 1139</a>
              </div>
              <div style={styles.contactItem}>
                <span style={styles.contactText}>Daily: 10:00 AM - 7:00 PM</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={styles.bottom}>
          ...
          <p style={styles.taglineSmall}>
            Made with <Heart size={14} fill="rgb(13, 121, 22)" color="rgb(13, 121, 22)" style={{ display: 'inline', verticalAlign: 'middle' }} /> for pets
          </p>
        </div>
      </div>
    </footer>
